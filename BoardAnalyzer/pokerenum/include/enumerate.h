...
//TODO: need to handle card duplication better
#define DECK_ENUMERATE_2_CARDS_NOSUITS_D(deck, cards_var, dead_cards, action)   \
do {                                                                    \
  int _i1; int _i2;							\
  deck##_CardMask _card1; deck##_CardMask _card2;			\
  deck##_CardMask _n2;							\
                                                                        \
  for (_i1 = deck##_Rank_ACE; _i1 >= 0; _i1--) {                       \
    _card1 = deck##_MASK(_i1);                                          \
    if (deck##_CardMask_ANY_SET(dead_cards, _card1))                    \
      continue;                                                         \
    for (_i2 = _i1; _i2 >= 0; _i2--) {                                \
      _card2 = deck##_MASK(_i2);                                        \
